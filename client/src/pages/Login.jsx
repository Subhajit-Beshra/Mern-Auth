        ...
        <form onSubmit={onSubmitHandler}>
          ...
          {state === 'Sign Up' && (
            <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
              ...
              <input onChange={e => setName(e.target.value)} value={Name} className='bg-transparent outline-0' type='text' placeholder='Full Name' required />
            </div>
          )}

          <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
            <img src={assets.mail_icon} alt='' />
            <input onChange={e => setEmail(e.target.value)} value={Email} className='bg-transparent outline-0' type='email' placeholder='Email id' required />
          </div>

          <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
            <img src={assets.lock_icon} alt='' />
            <input onChange={e => setPassword(e.target.value)} value={Password} className='bg-transparent outline-0' type='password' placeholder='Password' required />
          </div>
